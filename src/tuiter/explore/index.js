    ...
    return(
        <>
            ...
            <ul className="nav nav-pills mb-2 ">
                ...
                <li className="nav-item">
                    <a href="#" className="nav-link text-dark">Trending</a>
                </li>
                <li className="nav-item">
                    <a href="#" className="nav-link text-dark">News</a>
                </li>
            </ul>
            <div className="position-relative mb-2">
                <img alt={"No image rendered"} src={require("../../images/explore-for-you-1.jpg")} className="w-100"/>
                <h1 className="position-absolute wd-nudge-up text-white"> Musk buys Twitter </h1>
            </div>
            <PostSummaryList/>
        </>
    );
